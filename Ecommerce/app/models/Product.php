<?php 
    ...
    class Product extends Controller{
        ...
        public function add(
            $name,$desc,$user,$cat,$man,$image,$price,$quantity,$size,$color
            ){
            $this->db->query(
        ...
        public function update(
            $id,$name,$desc,$user,$img,$cat,$man,$price,$quantity,$size,$color
            ){
            $this->db->query("UPDATE products SET 
            name=:name,description=:description,user=:user,cat=:cat,
            man=:man,price=:price, quantity =:quantity,size=:size,color=:color,image=:image
