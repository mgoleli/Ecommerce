                ...
                <div class="col-8  m-auto">
                    <div class="card my-4">
                        <div class="card-header">
                            <h3 class='text-muted text-center'>Profil Düzenle</h3>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo URL ?>/users/update/<?php echo $data['user']->user_id ?>" method="POST">
                                <div class="form-group">
                                    <input value="<?php echo $data['user']->full_name ?>" type="text" name="full_name" placeholder="Ad Soyad" class="form-control <?php echo  isset($data['errName']) ?  'is-invalid' : '' ?>">
                                ...
                                <div class="form-group">
                                    <input type="submit" name='editProfile' value='Güncelle' class="btn btn-success btn-block">
                                </div>
                            </form>
                        </div>
                    </div>
