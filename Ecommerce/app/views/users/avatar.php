            ...
            <div class="row">
                ...
                <div class="card my-4">
                        ...
                        <div class="card-header">
                            <h5 class='text-muted text-center'>Avatar Ekle</h5>
                        </div>
                        <div class="card-body">
                            <form enctype="multipart/form-data" action="<?php echo URL?>/users/avatar/<?php echo Session::get('user_id') ?>" method="POST">
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="inputGroupFile01">Görsel Seç</label>
                                    </div>
                                    <div class="input-group-prepend">
                                        <input class="btn btn-outline-secondary" name='addAvatar' type="submit" value='Yükle'>
                                    </div>
                                </div>
