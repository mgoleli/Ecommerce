            ...
            <div class="row">
                ...
                <div class="card my-4">
                        ...
                        <div class="card-header">
                            <h5 class='text-muted text-center'>Yeni Ürün Ekle</h5>
                        </div>
                        <div class="card-body">
                            <form  enctype="multipart/form-data" action="<?php echo URL?>/products/add" method="POST">
    
                                <div class="form-group">
                                    <input type="text" name="name" placeholder="Ürün Adı" class="form-control <?php echo  isset($data['errName']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errName']) ?  '<div class="invalid-feedback">'.$data['errName'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="color" placeholder="Ürün Rengi" class="form-control <?php echo  isset($data['errColor']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errColor']) ?  '<div class="invalid-feedback">'.$data['errColor'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="size" placeholder="Ürün Size" class="form-control <?php echo  isset($data['errSize']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errSize']) ?  '<div class="invalid-feedback">'.$data['errSize'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="price" placeholder="Fiyat" class="form-control <?php echo  isset($data['errPrice']) ?  'is-invalid' : '' ?>">
                                ...
                                <a href='<?php echo URL ?>/products' class="btn btn-sm btn-secondary">
                                    ...
                                    <input type="submit" name='addProduct' value='Ekle' class="btn btn-success btn-sm">
                                </div>
