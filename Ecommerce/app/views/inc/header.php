        ...
        <ul class="navbar-nav mr-auto">
          ...
          <?php 
            if(!Session::existed('user_id')){ ?>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URL ?>/users/register">Kayıt</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URL ?>/users/login">Giriş</a>
                </li>
            <?php  }else{ 
              ?>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URL ?>/carts/orders">Siparişlerim</a>
                </li>
                <li class="nav-item dropdown user">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown01">
                        <a class="dropdown-item" href="<?php echo URL ?>/users/profile">Profil</a>
                        <a class="dropdown-item" href="<?php echo URL ?>/users/logout">Çıkış</a>
                    </div>
                </li>
            <?php  }
            ?>
