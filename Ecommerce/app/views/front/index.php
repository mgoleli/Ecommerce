...
<div class=" my-4 mx-auto">
        <h3 class='text-center my-4'>Ürünlerimiz</h3>
    ...
    <?php require_once ROOT ."/views/inc/slider.php" ?>
        ...
        <div class="row">
            ...
            if($data['products']){
                ...
                <p class="text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> Ürün yok</p>
                <?php  }
            ?>
        </div>
    </div>
