...
<div class=" my-4 mx-auto">
    <?php require_once ROOT ."/views/inc/slider.php" ?>
        <h3 class='text-center my-4'><?php echo $data['title1'] ?> Ürünler</h3>
        <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3">
                ...
                if($data['categories']){
                    ...
                    <?php }
                        ...
                        <p class="text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> Kategori Yok </p>
                        <?php  }
                    ?>
                </ul>
                ...
                if($data['manufactures']){
                    ...
                    <p class="text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span>  Marka Yok</p>
                    <?php  }
                ?>
                </ul>
                <hr class='bg-dark'>
            ...
            if($data['products']){
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 my-2">
                        <div class="card position-relative" >
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo URL ?>/home/show/<?php echo $pro->product_id ?>" class="btn btn-info btn-sm py-1 float-left" style="font-size:13px">Detaylar</a>
                ...
                <p class="text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> Bu kategoride ürün yok</p>
            <?php  }
             ?>
        </div>
    </div>
