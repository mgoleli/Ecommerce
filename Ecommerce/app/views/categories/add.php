            ...
            <div class="row">
                ...
                <div class="card my-4">
                        ...
                        <div class="card-header">
                            <h5 class='text-muted text-center'>Yeni Kategori Ekle</h5>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo URL?>/categories/add" method="POST">
    
                                <div class="form-group">
                                    <input type="text" name="category" placeholder="Kategori Adı" class="form-control <?php echo  isset($data['errCat']) ?  'is-invalid' : '' ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="submit" name='addCategory' value='Ekle' class="btn btn-success btn-sm">
                                </div>
