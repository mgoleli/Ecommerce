...
<?php require_once ROOT ."/views/inc/sidebar.php" ?>
    <div class="text-center mt-4">
        ...
        <h5>Kategori Yönetimi</h5>
            ...
            <input type="text" id='search_cat' class="form-control w-50 mx-auto" placeholder="Arama">
   
        
        <span class="float-right m-3">
            <a href="<?php echo URL ?>/categories/add">Yeni Kategori Ekle +</a>
        </span>
    ...
    <?php  }else{?>
                    <p class="text-center text-danger"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> Kategori Bulunamadı</p>
                    <?php  }?>
    </div>
